    ...
    render() {
        return (
            <BubbleSlide previous="/speech-example" next="/speech-recognition">
                <Bubble>
                    Let's dive into some code and see how we can make this
                    browser talk, shall we?
                </Bubble>
                <Bubble>
                    Modern browsers have started implementing the speech API,
                    we'll use this API to make the browser talk.
                </Bubble>
                ...
                <Bubble>
                    Once we have this synthesizer, we can create a new speech
                    synthesis utterance.
                </Bubble>
                <Bubble full>
                ...
                <Bubble>
                    The last thing we have to do is let the synthesizer say our
                    words.
                </Bubble>
                <Bubble full>
                ...
                {window.speechSynthesis &&
                    <Bubble onShow={this.talkMale}>Hi everybody</Bubble>}
                <Bubble>
                    Ok cool, but I'm a female cat and the default English voice
                    is a male one. How do I change this?
                </Bubble>
                <Bubble full>
                    <Code code={this.codeExample4} />
                </Bubble>
                {window.speechSynthesis &&
                    <Bubble onShow={this.talkFemale}>
                        Now, this is better, dont you think?
                    </Bubble>}
