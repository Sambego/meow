    ...
    render() {
        return (
            <BubbleSlide previous="notification-push" next="acknowledgements">
                ...
                <Bubble>Once the service-worker is register, you can subscribe to the <code>pushManager</code>, and send the subscription to your push server.</Bubble>
                <BubbleCollection>
                    <CodeCaption>main.js</CodeCaption>
                    <Bubble full>
                ...
                <Bubble>Once subscribed to a push server, you can use the service-worker to listen to push events. With everey push event you can do a whole lot of things, but for this example we'll show a notification.</Bubble>
                <BubbleCollection>
