...
export default class AcknowledgementPage extends Component {
    render() {
        return (
            <BubbleSlide previous="/bonus" next="/thanks">
                <BubbleCollection>
                    ...
                    <Bubble>The cat illustrations are based on <a target="_blank" href="https://dribbble.com/shots/1515855-AI-Cat">this</a> cat</Bubble>
                </BubbleCollection>
            </BubbleSlide>
        );
    }
