...
var Icon = function Icon(_ref) {
    ...
    var src = __webpack_require__(68)("./" + name + '.svg');
    var props = {
    ...
    return (0, _preact.h)('div', _extends({ dangerouslySetInnerHTML: { __html: src } }, props));
};
...
var Slide = function Slide(_ref) {
    ...
    var keys = {
        left: function left() {
            if (previous) {
                _preactRouter2.default.route(previous);
                window.removeEventListener('keyup', onKeyup);
            }
        },
        right: function right() {
            if (next) {
                _preactRouter2.default.route(next);
                window.removeEventListener('keyup', onKeyup);
            }
        }
    };
...
// module
exports.push([module.i, ".bubbles__bubbles___2yGAj{overflow-x:hidden;overflow-y:auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:end;-ms-flex-pack:end;justify-content:flex-end;height:100%}", ""]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=script.d267fd3e8140b9016e39.js.map